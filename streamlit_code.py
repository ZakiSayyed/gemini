...
view = st.sidebar.selectbox("Select an option", ["Talk to you Data", "Load Data to SQLite"])

if view == "Talk to you Data":
    ...
    prompt = """
    You are an expert in writing SQL queries. Based on the provided database metadata and user question generate only SQL Queries. 
