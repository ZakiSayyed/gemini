...
prompt = st.text_area("Enter your prompt", value="""You are an expert in writing SQL queries. Based on the provided database metadata and user question, generate a SQL query to identify records with duplicate values in a specified column. The query should:
